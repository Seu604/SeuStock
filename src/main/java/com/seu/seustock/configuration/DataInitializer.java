...
public class DataInitializer implements CommandLineRunner {
    ...
    private static final List<String> SAMPLE_IMAGE_FILENAMES = List.of(
            "tissue.png", "driver.png", "mug.png", "keyboard.png"
    );

    private static final List<String> ITEM_NAMES = List.of(
            "휴지", "드라이버", "머그컵", "키보드",
            "마우스", "노트북", "펜", "노트", "가위", "테이프",
            "스테이플러", "USB 케이블", "이어폰", "충전기", "책",
            "시계", "우산", "물병", "안경", "지갑",
            "리모컨", "건전지", "전구", "소켓", "공구함"
    );
    ...
    private List<ImageDTO> uploadSampleImages(UserDTO owner) throws IOException, NoSuchAlgorithmException {
    ...
    private List<StockDTO> createStocksAndTransactions(List<ItemDTO> items,
                                                      SpaceDTO space,
