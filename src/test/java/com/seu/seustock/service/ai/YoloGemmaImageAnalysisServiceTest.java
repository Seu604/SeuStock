...
class YoloGemmaImageAnalysisServiceTest {
    ...
    @Mock
    private YoloDetectionClient yoloDetectionClient;
    @Mock
    private GemmaVisionClient gemmaVisionClient;

    @Test
    void analyze_rejectsSpoofedImageBeforeCallingClients() throws Exception {
        YoloGemmaImageAnalysisService service = new YoloGemmaImageAnalysisService(
        ...
        verify(gemmaVisionClient, never()).analyze(
                any(),
                any(),
                anyInt(),
                any(),
