 ...
 * <p>
 * 모든 컨트롤러 테스트 클래스가 상속받아 사용한다.
 * 서비스 계층은 각 하위 클래스에서 {@code @MockitoBean}으로 대체하여
 * HTTP 계약(라우팅·보안·Validation·HTMX 응답 형태)만 검증한다.
 */
@SpringBootTest
...
abstract class AbstractControllerTest {
    ...
    /**
     * 응답에 {@code HX-Trigger} 헤더가 존재하고 {@code "app:toast"}를 포함하는지 검증하는 ResultMatcher.
     * 성공/오류 HTMX 토스트 알림 검증에 사용.
     */
